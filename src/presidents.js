...
function getDemocraticPresidents(presidentsArr) {
  return presidentsArr.filter((president) =>
    president.party ? president.party === "Democratic" : false
  );
}
...
function getAgeAtInauguration(presidentsArr) {
  return presidentsArr.map((president) => {
    if (
      typeof president.tookOffice === "number" &&
      typeof president.birthYear === "number"
    ) {
      president["ageAtInauguration"] =
        president.tookOffice - president.birthYear;
    } else {
      president["ageAtInauguration"] = undefined;
    }
    return president;
  });
}
// console.log("age@inaug", getAgeAtInauguration(presidents));
